...
This directory stores durable learnings for future AI agents working on `owt`.

Read these before changing architecture, repository-layout behavior, documentation policy, release assets, or agent guidance:
